...
query1 = "SELECT * FROM table1 WHERE lastmod = '2022-08-08'"
query2 = "SELECT * FROM table2 WHERE lastmod = '2022-08-08'"
...
# join_query = """
#     SELECT t1.lastmod,t1.loc
#     FROM table1 as t1
#     JOIN table2 as t2 
#     ON t1.lastmod = t2.lastmod
#     WHERE t1.lastmod = '2022-08-08' AND t1.loc != t2.loc  
# """
